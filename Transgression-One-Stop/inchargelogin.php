...
if(isset($_POST['s']))
{
    session_start();
    $_SESSION['x']=1;
    $conn=mysqli_connect("localhost","root","password","crime_portal");
    if(!$conn)
    {
...
<body style="color: black;background-image: url(locker.jpg);background-size: 100%;background-repeat: no-repeat;back">
...
<div style="position: fixed;
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;">&copy <b>Arpita-1NH18IS016</b></h4>
</div>
